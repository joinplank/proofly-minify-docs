...
<AccordionGroup>
  <Accordion title="Use SDK for API Calls">
    The official SDK provides convenient methods for checking job status. You'll still need to implement polling logic yourself, but the SDK makes API calls easier.
  </Accordion>
